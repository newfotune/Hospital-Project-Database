<%@ Page Title="Add Doctor" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="add_doctor.aspx.cs" Inherits="views_Admin_Doctor_admin_doctor_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Maincontent" runat="Server">
   <div id="add_doctor_div">
       <table>
           ...
           <tr>
               <td><label for="state">Role</label></td>
               <td><asp:DropDownList runat="server" ID="doc_role"></asp:DropDownList></td>
           </tr>
       </table>
   </div>
    <asp:Button ID="add" runat="server" OnClick="add_click" Text="ADD DOCTOR" />
