...
public partial class views_Admin_Doctor_admin_doctor_add : System.Web.UI.Page
{
    ...
    private void LoadUpDropDowns()
    {
        ...
        doc_role.Items.Add(new ListItem("Trainee"));
        doc_role.Items.Add(new ListItem("Permanent"));
        doc_role.Items.Add(new ListItem("Visiting"));
    ...
    protected void add_click(object sender, EventArgs e)
    {
       ...
       // DBManager.fixAutoIncreament();
        CheckSuccess(DBManager.AddEmployee(_hireDate, _salary, 1), "Employee");
       // DBManager.fixAutoIncreament();
        CheckSuccess(DBManager.AddDoctor(_role), "Doctor");
       // DBManager.fixAutoIncreament();
