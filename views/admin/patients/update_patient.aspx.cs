...
public partial class views_Admin_Patients_admin_patient_update : System.Web.UI.Page
{
    ...
    {
        Object theObject = DBManager.GetData("SELECT person.person_id, person.first_name, person.last_name, person.phone,person.email," +
                                        "patient.height_inches, patient.weight_Pounds, room.room_number AS Room_Assigned" +
                                        " FROM person" +
